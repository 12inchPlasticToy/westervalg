...
<html>
    <head>
        <title>Utvalg - Kvinner i IT</title>
        <meta charset="utf-8">
    ...
    <div id="utvalgContent">
        <div class="logo">
            <img src="../logos/logo_kit.png" alt="logo">
        </div>
        <h1>Kvinner i IT</h1>
        <p>Kvinner og IT er en forening for jenter som studerer IT på Westerdals Oslo ACT Campus Galleri.</p>

        <p>Det er bare å ta kontakt hvis du har ønsker eller innspill til hva vi kan finne på. Ta enten kontakt med en i styret eller send mail til: Kitwesterdals@gmail.com </p>
        
    </div>
    <div id="contactBox">
        <h4>Kontaktinformasjon</h4>
        <p>Styremedlemmer</p>
        <p>Leder: Sigrun Melby Gjengset</p>
